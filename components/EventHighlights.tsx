...
const highlights = [
  { 
    ...
    longDesc: "An exclusive visit for 60-70 students to a top tech campus in Bengaluru. Get insights from industry professionals, learn about open-source contributions, and explore career paths in cloud-native technologies.",
