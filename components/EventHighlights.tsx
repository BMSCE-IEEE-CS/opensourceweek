...
const highlights = [
  {
    ...
    desc: "Guided tour and sessions on cloud, DevOps and careers. 60-70 students.",
  },
  { title: "Workshops (Day 2)", desc: "GitHub 101 • Agentic AI Unpacked" },
  {
    title: "Contribution Sprint (Day 3)",
    desc: "Mentored sprint to submit issues, fixes and features (virtual available).",
  },
  {
    title: "RepoGenesis — 24-Hour Hackathon (Days 4-5)",
    desc: "Teams build open-source solutions with mentorship & checkpoints.",
  },
];
