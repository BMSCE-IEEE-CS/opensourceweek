...
export default function QRPage({ uid }: { uid: string }) {
  ...
  const qrValue = `https://osweek.bmsceieeecs.in/repogenesis/scan?id=${uid}`;
  ...
  return (
    <div className="p-6 max-w-xl mx-auto text-center bg-white/35 text-white">
      ...
      {participant.team && (
        <p className="text-gray-300 text-xl mt-1">Team: {participant.team}</p>
      )}
      ...
      <div className="mt-10 p-4 bg-white/60 rounded-xl shadow text-left space-y-2 text-black">
